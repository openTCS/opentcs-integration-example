...
import com.example.commadapter.vehicle.exchange.commands.SetIdleTimeoutCommand;
import com.example.commadapter.vehicle.exchange.commands.SetLoggingEnabledCommand;
import com.example.commadapter.vehicle.exchange.commands.SetReconnectingOnConnectionLossCommand;
...
public class ControlPanel
  ...
  private void initComponents() {
    ...
    java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("com/example/commadapter/vehicle/Bundle"); // NOI18N
    ...
    connectedButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/example/commadapter/vehicle/res/symbols/LEDGray.gif"))); // NOI18N
    connectedButton.setText(bundle.getString("AdapterConnected")); // NOI18N
    connectedButton.setBorderPainted(false);
    connectedButton.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/com/example/commadapter/vehicle/res/symbols/LEDRed.gif"))); // NOI18N
    connectedButton.setDisabledSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/com/example/commadapter/vehicle/res/symbols/LEDGreen.gif"))); // NOI18N
  ...
  activeButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/example/commadapter/vehicle/res/symbols/LEDGray.gif"))); // NOI18N
  activeButton.setText(bundle.getString("ControlPanel.AdapterActive")); // NOI18N
  activeButton.setBorderPainted(false);
  activeButton.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/com/example/commadapter/vehicle/res/symbols/LEDRed.gif"))); // NOI18N
  activeButton.setDisabledSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/com/example/commadapter/vehicle/res/symbols/LEDGreen.gif"))); // NOI18N
